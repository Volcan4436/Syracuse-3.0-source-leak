...
//		}
        ...
        for (BlockPos neighbor : neighbors) {
            ...
            BlockHitResult hit = mc.world.raycastBlock(RenderUtils.getCameraPos(), faceCenter, neighbor, BlockUtils.getBlockState(neighbor).getOutlineShape(mc.world, neighbor), BlockUtils.getBlockState(neighbor));
            if (hit == null) {
